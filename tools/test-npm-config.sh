...
check GET "/webapi/entry.cgi?api=SYNO.FotoTeam.Browse.Folder&version=2&method=list" 403 "browse shared folders"
...
check GET "/webapi/entry.cgi?api=SYNO.FotoTeam.Delete&version=1&method=delete" 403 "delete shared photos"
